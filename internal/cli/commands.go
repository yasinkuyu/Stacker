...
import (
	...
	"stacker-app/internal/forge"
	"stacker-app/internal/logs"
	"stacker-app/internal/mail"
	"stacker-app/internal/node"
	"stacker-app/internal/php"
	"stacker-app/internal/server"
	"stacker-app/internal/services"
	"stacker-app/internal/tray"
	"stacker-app/internal/utils"
	"stacker-app/internal/web"
...
var uiCmd = &cobra.Command{
	Use:   "ui",
	Short: "Start web UI (opens in browser)",
...
var statusCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("Stacker App Status")
		fmt.Println("═════════════════")
